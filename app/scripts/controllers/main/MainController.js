(function (module) {
  mifosX.controllers = _.extend(module, {
    MainController: function (
      ...
      if (
        !scope.islogofoldernamefetched &&
        $rootScope.tenantIdentifier &&
        $rootScope.tenantIdentifier != 'default'
      ) {
        scope.islogofoldernamefetched = true;
        $http
          .get('scripts/config/LogoConfig.json')
          .then(function onSuccess(response) {
            var datas = response.data;
            for (var i in datas) {
              var data = datas[i];
              if (
                data.tenantIdentifier != undefined &&
                data.tenantIdentifier == $rootScope.tenantIdentifier
              ) {
                if (
                  data.logofoldername != undefined &&
                  data.logofoldername != ''
                ) {
      ...
      if (localStorageService.getFromLocalStorage('Location')) {
        scope.activityQueue =
          localStorageService.getFromLocalStorage('Location');
      }
      scope.loadSC = function () {
        ...
        scope.searchCriteria =
          localStorageService.getFromLocalStorage('searchCriteria');
      };
      ...
      $rootScope.hasPermission = function (permission) {
        ...
        $rootScope.permissionList =
          localStorageService.getFromLocalStorage('userPermissions');
        //If user is a Super user return true
        if (
          $rootScope.permissionList &&
          _.contains($rootScope.permissionList, 'ALL_FUNCTIONS')
        ) {
          return true;
        } else if (
          $rootScope.permissionList &&
          ...
          if (
            ...
            _.contains($rootScope.permissionList, 'ALL_FUNCTIONS_READ')
          ) {
            return true;
      ...
      scope.$on('UserAuthenticationSuccessEvent', function (event, data) {
        ...
        if (sessionManager.get(data)) {
          ...
          scope.start(scope.currentSession);
          if (
            scope.currentSession.user &&
            scope.currentSession.user.userPermissions
          ) {
            $rootScope.setPermissions(
              scope.currentSession.user.userPermissions,
            );
          }
      ...
      scope.text =
        '<span>TIB Finance is designed by the <a href="http://www.openmf.org/">Mifos Initiative</a>.' +
      ...
      scope.helpf = function () {
        ...
        var addresses = [
          'https://mifosforge.jira.com/wiki/display/docs/User+Setup',
          'https://mifosforge.jira.com/wiki/display/docs/Organization',
          'https://mifosforge.jira.com/wiki/display/docs/System',
          'https://mifosforge.jira.com/wiki/dosearchsite.action?queryString=products&startIndex=0&where=docs',
          'https://mifosforge.jira.com/wiki/pages/viewpage.action?pageId=67141762',
          'https://mifosforge.jira.com/wiki/dosearchsite.action?queryString=report&startIndex=0&where=docs',
          'https://mifosforge.jira.com/wiki/dosearchsite.action?queryString=accounting&startIndex=0&where=docs',
          'https://mifosforge.jira.com/wiki/display/docs/Manage+Clients',
          'https://mifosforge.jira.com/wiki/display/docs/Manage+Groups',
          'https://mifosforge.jira.com/wiki/display/docs/Manage+Centers',
          'https://mifosforge.jira.com/wiki/display/docs/User+Manual',
          'https://mifosforge.jira.com/wiki/display/docs/Manage+Offices',
          'https://mifosforge.jira.com/wiki/display/docs/Manage+Holidays',
          'https://mifosforge.jira.com/wiki/display/docs/Manage+Employees',
          'https://mifosforge.jira.com/wiki/display/docs/Manage+Funds',
          'https://mifosforge.jira.com/wiki/display/docs/Bulk+Loan+Reassignment',
          'https://mifosforge.jira.com/wiki/display/docs/Currency+Configuration',
          'https://mifosforge.jira.com/wiki/display/docs/Standing+Instructions+History',
          ...
          'https://mifosforge.jira.com/wiki/display/docs/Maker-Checker',
          'https://mifosforge.jira.com/wiki/display/docs/Manage+Hooks',
          'https://mifosforge.jira.com/wiki/display/docs/Audit+Trails',
          'https://mifosforge.jira.com/wiki/display/docs/Manage+Reports',
          'https://mifosforge.jira.com/wiki/display/docs/Manage+Scheduler+Jobs',
          'https://mifosforge.jira.com/wiki/display/docs/Global+Configuration',
          'https://mifosforge.jira.com/wiki/dosearchsite.action?queryString=account%20number%20preferences&startIndex=0&where=docs',
          'https://mifosforge.jira.com/wiki/dosearchsite.action?queryString=loan%20products&startIndex=0&where=docs',
          'https://mifosforge.jira.com/wiki/dosearchsite.action?queryString=saving%20products&startIndex=0&where=docs',
          'https://mifosforge.jira.com/wiki/dosearchsite.action?queryString=charges&startIndex=0&where=docs',
          'https://mifosforge.jira.com/wiki/dosearchsite.action?queryString=products%20mix&startIndex=0&where=docs',
          'https://mifosforge.jira.com/wiki/dosearchsite.action?queryString=fixed%20deposit%20products&startIndex=0&where=docs',
          'https://mifosforge.jira.com/wiki/dosearchsite.action?queryString=recurring%20deposit%20products&startIndex=0&where=docs',
          'https://mifosforge.jira.com/wiki/pages/viewpage.action?pageId=67895308',
          'https://mifosforge.jira.com/wiki/display/docs/Add+Journal+Entries',
          'https://mifosforge.jira.com/wiki/dosearchsite.action?queryString=search%20journal%20entries&startIndex=0&where=docs',
          'https://mifosforge.jira.com/wiki/dosearchsite.action?queryString=accounts%20linked&startIndex=0&where=docs',
          'https://mifosforge.jira.com/wiki/display/docs/Chart+of+Accounts+and+General+Ledger+Setup',
          'https://mifosforge.jira.com/wiki/display/docs/Closing+Entries',
          'https://mifosforge.jira.com/wiki/pages/viewpage.action?pageId=67895308',
          'https://mifosforge.jira.com/wiki/display/docs/Accruals',
        ];
        ...
        var addrmodels = [
          ...
          '/journalentry',
          '/searchtransaction',
          '/financialactivityaccountmappings',
          '/accounting_coa',
          '/accounts_closure',
          '/accounting_rules',
        ...
        var addrfound = false;
        if (
          whereweare == '/reports/all' ||
          whereweare == '/reports/clients' ||
          whereweare == '/reports/loans' ||
          whereweare == '/reports/savings' ||
          whereweare == '/reports/funds' ||
          whereweare == '/reports/accounting' ||
          whereweare == '/xbrl'
        ) {
        ...
        if (addrfound == false) window.open('http://www.google.com'); // substring not matching to any model -> open start user manual page
      }; //helpf
